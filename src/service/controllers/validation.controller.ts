...
export const validatePrams = (schema: Schema, options: any = defaultOptions) => (req: Request, res: Response, next: NextFunction): void => {
...
export const validateBody = (schema: Schema, options: any = defaultOptions) => (req: Request, res: Response, next: NextFunction): void => {
